...
class LLMNeedleHaystackTester:
    ...
    def __init__(self,
        ...
        self.model_to_test, self.enc = load_model_and_tokenizer(args)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--method', type=str, default="full", choices=['fullkv', 'pyramidkv', 'heterocache', 'snapkv', 'streamingllm', 'h2o'])
